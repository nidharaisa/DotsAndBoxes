...
//        this.level = 1;
    ...
    public Field(int row, int col, Test test)
    {
        this(row, col);
        this.test =test;
    }
...
//        g.fillRect(bounds.x, bounds.y, bounds.width, bounds.height);
        ...
        for (int i = 1; i <= rows; i++) {
            for (int j = 1; j <= cols; j++) {
                ...
                if (boxses[i][j].degree == 0) {
                    ...
                    // g.drawString(boxses[i][j].name, origin.y + j * boxL+boxL/2,origin.x + i * boxL+boxL/2);
    ...
    public void mouseReleased(MouseEvent e) {
        ...
        x = e.getX() + boxL;
        y = e.getY() + boxL;
//        X.setPosition(x + " X pos ");
//        Y.setPosition(y + " Y pos ");
        int[] n = getNearestLine(x, y);
//        System.out.println("----->The User choose The Box = [" + n[0] + "][" + n[1] + "] side= " + n[2]);
...
//            new NewGameDialogue().showDialog();
//            this.test.dispose();
        }
    }
...
//        System.out.println("X, Y , side =" + n[0] + " " + n[1] + " " + n[2]);
//        this.repaintLine(n[2] % 2, n[0], n[1]);
        this.repaint();
    }
...
//        System.out.println("-->X, Y row, col " + x + " " + y + " " + row + " " + col);
        n[0] = row;
        n[1] = col;
        n[2] = nearestBox.getNearestLine(x, y, boxL);
//        repaintLine(row, col, row);
        return n;
    }
