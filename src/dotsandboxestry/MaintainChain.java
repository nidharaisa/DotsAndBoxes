...
//        System.out.println("m*n -> "+(m*n));
        for(i=0; i<5; i++)
            degrees[i] = 0;
        degrees[4] = n*m;
//        System.out.println("degree[4]-> "+degrees[4]);
    }
...
//        if(degrees[4]>0 || degrees[3]>0){
            while(test>0){
                test--;
                i = ri.nextInt(n) + 1; j = rj.nextInt(m) + 1;
                if(boxes[i][j].degree<=2) continue;
                side = checkMove(boxes[i][j]);
//                System.out.println("pos "+i+" "+j+" "+boxes[i][j].degree);
                if(side>0)
                {
                        ...
                        if(k==0){
                            ...
                            if(tem==1){
                                if(availMove()%2 == 0){
                                    ...
                                    lastBox = boxes[i][j]; lastSide = DOWN;
                                    which = num;
                                }
                            }
                        }
                        ...
                        if(k==0){
                            ...
                            if(tem==1){
                                if(availMove()%2 == 0){
                                    ...
                                    lastBox = boxes[i][j]; lastSide = LEFT;
                                    which = num;
                                }
                            }
                        }
                        ...
                        if(k==0){
                            ...
                            if(tem==1){
                                if(availMove()%2 == 0){
                                    ...
                                    lastBox = boxes[i][j]; lastSide = RIGHT;
                                    which = num;
                                }
                            }
                        }
